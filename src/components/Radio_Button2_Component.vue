...
<script>
  export default {
    props: ['containerClasses', 'idValue1', 'idValue2', 'radioButtonClasses', 'radioButtonLabel1', 'radioButtonLabel2',
      'radioButtonName', 'radioButtonTitle', 'radioButtonValue1', 'radioButtonValue2', 'titleClasses'],
